...
class LargeController(view: ViewGroup, onClick:(Action)->Unit, onSeekBarChangeListener: SeekBar.OnSeekBarChangeListener): Controller(
    R.layout.controller_large, view) {
